const commonTexts = {
  signIn: {
    phoneCode: {
      title: "आफ्नो फोन हेर्नुहोस्",
      subtitle: "{{applicationName}} प्रयोग गर्न",
      formTitle: "प्रमाणीकरण कोड",
      formSubtitle: "तपाईको फोन नम्बरमा पठाइएको प्रमाणिकरण कोड लेख्नुहोस्",
      resendButton: "कोड प्राप्त गर्नुभएन? पुन: पठाउनुहोस्",
    },
  },
} as const;
...
export const ne = {
  locale: "ne-NP",
  socialButtonsBlockButton: "{{provider|titleize}} साथ जान्छु",
  dividerText: "वा",
  formFieldLabel__emailAddress: "इ-मेल",
  formFieldLabel__emailAddresses: "इ-मेल",
  formFieldLabel__phoneNumber: "फोन नम्बर",
  formFieldLabel__username: "प्रयोगकर्ता नाम",
  formFieldLabel__emailAddress_phoneNumber: "इ-मेल वा फोन नम्बर",
  formFieldLabel__emailAddress_username: "इ-मेल वा प्रयोगकर्ता नाम",
  formFieldLabel__phoneNumber_username: "फोन नम्बर वा प्रयोगकर्ता नाम",
  formFieldLabel__emailAddress_phoneNumber_username:
    "इ-मेल, फोन नम्बर वा प्रयोगकर्ता नाम",
  formFieldLabel__password: "पासवर्ड",
  formFieldLabel__currentPassword: "हालको पासवर्ड",
  formFieldLabel__newPassword: "नयाँ पासवर्ड",
  formFieldLabel__confirmPassword: "नयाँ पासवर्ड फेरि एकचोटी",
  formFieldLabel__signOutOfOtherSessions:
    "अन्य सबै यन्त्रहरूबाट साइन आउट गर्नुहोस्",
  formFieldLabel__automaticInvitations:
    "यस डोमेनका लागि स्वचालित निमन्त्रणाहरू सक्षम गर्नुहोस्",
  formFieldLabel__firstName: "नाम",
  formFieldLabel__lastName: "थर",
  formFieldLabel__backupCode: "ब्याकअप कोड",
  formFieldLabel__organizationName: "संगठनको नाम",
  formFieldLabel__organizationSlug: "Slug URL",
  formFieldLabel__organizationDomain: "डोमेन",
  formFieldLabel__organizationDomainEmailAddress: "प्रमाणीकरण इ-मेल",
  formFieldLabel__organizationDomainEmailAddressDescription:
    "कोड प्राप्त गर्न र यो डोमेन प्रमाणित गर्न यो डोमेन अन्तर्गत एउटा इ-मेल दिनुहोस्",
  formFieldLabel__organizationDomainDeletePending:
    "विचाराधीन निमन्त्रणा र सुझावहरू मेटाउनुहोस्",
  formFieldLabel__confirmDeletion: "मेटाउने निश्चित गर्नुहोस्",
  formFieldLabel__role: "भूमिका",
  formFieldInputPlaceholder__emailAddress: "तपाईको इ-मेल यहाँ लेख्नुहोस्",
  formFieldInputPlaceholder__emailAddresses:
    "तपाईको इ-मेलहरू यहाँ लेख्नुहोस्, खाली ठाउँ ( ) वा अल्पविरामद्वारा (,) विभाजित गर्नुहोस्",
  ...
  formFieldInputPlaceholder__confirmDeletionUserAccount: "खाता मेटाउनुहोस्",
  formFieldError__notMatchingPasswords: `पासवर्डहरू एउटै भएन ।`,
  formFieldError__matchingPasswords: "पासवर्डहरू एउटै भयो ।",
  formFieldError__verificationLinkExpired:
    "प्रमाणीकरण लिङ्कको म्याद सकियो। कृपया नयाँ लिङ्क अनुरोध गर्नुहोस् ।",
  formFieldAction__forgotPassword: "पासवर्ड बिर्सनुभयो?",
  formFieldHintText__optional: "वैकल्पिक",
  formFieldHintText__slug:
    "A slug is a human-readable ID that must be unique. It’s often used in URLs.",
  formButtonPrimary: "जारी राख्नु",
  signInEnterPasswordTitle: "आफ्नो पासवर्ड लेख्नुहोस्",
  backButton: "पछाडी जाउ",
  ...
  signUp: {
    start: {
      title: "नयाँ खाता बनाउनुहोस्",
      subtitle: "{{applicationName}} प्रयोग गर्न",
      actionText: "मेरो खाता छ",
      actionLink: "साइन इन",
    },
    emailLink: {
...
export const rn = {
  locale: "rn-NP",
  socialButtonsBlockButton: "{{provider|titleize}} bata",
  dividerText: "ki",
  ...
  formFieldLabel__emailAddress_phoneNumber: "Email address ki phone number",
  formFieldLabel__emailAddress_username: "Email address ki username",
  formFieldLabel__phoneNumber_username: "phone number ki username",
  formFieldLabel__emailAddress_phoneNumber_username:
    "Email address, phone number ki username",
  formFieldLabel__password: "Password",
  formFieldLabel__currentPassword: "Ahiley ko password",
  formFieldLabel__newPassword: "Naya password",
  formFieldLabel__confirmPassword: "Confirm password",
  formFieldLabel__signOutOfOtherSessions: "Aru sabai devices bata sign out",
  formFieldLabel__automaticInvitations:
    "Enable automatic invitations for this domain",
  formFieldLabel__firstName: "Naam",
  formFieldLabel__lastName: "Thar",
  ...
  formFieldInputPlaceholder__organizationDomain: "",
  formFieldInputPlaceholder__organizationDomainEmailAddress: "",
  formFieldInputPlaceholder__confirmDeletionUserAccount: "Account delete",
  formFieldError__notMatchingPasswords: `Xuttai password vayo.`,
  formFieldError__matchingPasswords: "Password haru eutai vayo.",
  formFieldError__verificationLinkExpired:
    "Verification link expired vayo naya request garum.",
  formFieldAction__forgotPassword: "Password Bhulyo?",
  formFieldHintText__optional: "Optional",
  formFieldHintText__slug:
    "Slug vaneko unique id ho jun chai mathi URL ma hunxa",
  formButtonPrimary: "Continue",
  signInEnterPasswordTitle: "Tapaiko Password",
  backButton: "Back",
  footerActionLink__useAnotherMethod: "Arko tarika",
  badge__primary: "Primary",
  badge__thisDevice: "Yo device",
  badge__userDevice: "User device",
  badge__otherImpersonatorDevice: "Other impersonator device",
  badge__default: "Default",
  badge__unverified: "Unverified",
  ...
  signUp: {
    start: {
      title: "Naya account banam",
      subtitle: "{{applicationName}} chalauna lai",
      actionText: "Mero account xa.",
      actionLink: "Sign in",
    },
    emailLink: {
      title: "Email verify garum",
      subtitle: "{{applicationName}} chalauna lai",
      formTitle: "Verification link",
      formSubtitle: "Tapaiko email ma link aako xa tesma thichnus",
      resendButton: "Link nai aayena? Feri patham na",
      verified: {
        title: "Sign up vayo",
      },
      loading: {
      ...
      verifiedSwitchTab: {
        title: "Email verify vayo",
        subtitle: "Naya khuleko tab ma hernu",
        subtitleNewTab: "Aginai ko tab ma jam",
      },
    },
    emailCode: {
      title: "Email verify garnus",
      subtitle: "{{applicationName}} chalauna lai",
      formTitle: "Verification code",
      formSubtitle: "Tapaiko email ma aako verification code lekhnus",
      resendButton: "Code nai aayena? Feri patham na",
    },
    phoneCode: {
      title: "Phone number verify garnus",
      subtitle: "{{applicationName}} chalauna lai",
      formTitle: "Verification code",
      formSubtitle: "Tapaiko Phone number ma aako verification code lekhnus",
      resendButton: "Code nai aayena? Feri patham na",
    },
    continue: {
      title: "Xuteko thau feri varnus",
      subtitle: "{{applicationName}} chalauna lai",
      actionText: "Mero account xa.",
      actionLink: "Sign in",
    },
  ...
  signIn: {
    ...
    totpMfa: {
      ...
      subtitle: "",
      formTitle: "Verification code",
      formSubtitle: "Authenticator app le generate gareko code lekhnus",
    },
    backupCodeMfa: {
      title: "Enter a backup code",
      subtitle: "to continue to {{applicationName}}",
